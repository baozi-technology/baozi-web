...
We will see the advantages and drawbacks of each approach, and observe real-life examples. If you are unconfortable with the notions of open-source, free software and the different software licenses, read the [first part of this serie](https://baozi.technology/)! For my thoughts on the ethical stance of both movements, check out the [second part of this serie](https://baozi.technology/).
