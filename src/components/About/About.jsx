    ...
    return (
      <div className={styles.aboutContainer}>
        <div className={[styles.whatIdoContainer, styles.maxWidth].join(" ")}>
          <h2>What I do</h2>
          <p>
            Most of my professional experiences revolve around softwares written
            for the physical world industries such as Aerospace and Defense.
            Only recently did I start doing web development, a very different
            industry in many ways.
          </p>
          <p>
            I always try to code in the language the most suitable for each
            project, regardless of my current knowledge and preferences.
            Disclaimer: I am most experienced in Python and Java but I am rather
            language-agnostic.
          </p>
          <p>
            {" "}
          ...
          <p>
            I spend lots of my time learning about the new technology and
            business trends.
          </p>
        </div>
        ...
        <div className={[styles.whyBaoziContainer, styles.maxWidth].join(" ")}>
          ...
          <p>
            ...
            pieces of software ;). More about this flawless analogy Soon™ on
            this blog.
          </p>
          <p>
