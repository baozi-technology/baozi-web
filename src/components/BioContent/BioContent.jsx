...
const BioContent = (props) => {
  ...
  var bio = (
    <span>Hi! I’m Nicolas – fullstack software engineer based in France. 
        My main area of expertise is concurrent backend services that deal with various non-standard protocols.  
